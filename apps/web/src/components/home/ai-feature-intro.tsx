    ...
    <Section className="bg-surface">
      <Container className="grid gap-10 md:grid-cols-[1fr_1.1fr] md:items-center">
        ...
        <div className="rounded-3xl border border-border bg-background p-6 shadow-sm">
          <div className="space-y-6 rounded-2xl bg-surface p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="h-32 rounded-2xl border border-border bg-background" />
              <div className="flex flex-col justify-between rounded-2xl border border-border bg-background p-4 text-sm text-muted">
